...
public class Type {
	...
	public static Map<String, String> lookupFieldTypes(final ClassNode cn) {
		...
		if(fields != null) {
			...
			while(fieldIt.hasNext()) {
				...
				values.put(field.name, field.desc);
			}
		}
		return values;
	}
	
	public static Map<String,String> lookupVarTypes(final MethodNode mn) {
		final Map<String, String> values = new HashMap<String, String>();
